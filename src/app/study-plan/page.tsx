  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-foreground/15 selection:text-foreground">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {/* Header */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-7 shadow-sm space-y-1.5">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white">5-Day Syllabus Preparation Schedule</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-12 text-center text-slate-500 space-y-4 shadow-sm">
            <AlertCircle className="w-12 h-12 text-amber-500 mx-auto opacity-80" />
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">{errorMessage}</h3>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border p-12 text-center text-slate-400 space-y-4">
          ...
          <div className="space-y-4">
            {studyPlan.schedule.map((dayItem: any) => (
              <div
                key={dayItem.day}
                className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6"
              >
                <div className="space-y-3 flex-1">
                  <div className="flex items-center gap-2.5">
                    <span className="w-8 h-8 rounded-xl bg-teal-100 dark:bg-teal-950 text-teal-700 dark:text-teal-300 font-black text-xs flex items-center justify-center">
                      D{dayItem.day}
                    </span>
                ...
                <Link
                  href="/dashboard"
                  className="px-4 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 text-slate-800 dark:text-slate-200 font-bold text-xs rounded-xl flex items-center gap-1.5 transition-all shrink-0"
                >
